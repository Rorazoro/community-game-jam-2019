...
{
	[SerializeField] private LayeredUnityEventCollider2DTriggerData[] _onTriggerEnterData;
	[SerializeField] private LayeredUnityEventCollider2DTriggerData[] _onTriggerStayData;
	[SerializeField] private LayeredUnityEventCollider2DTriggerData[] _onTriggerExitData;
	...
	private void Reset()
	{
		...
		{
			this._onTriggerEnterData = new LayeredUnityEventCollider2DTriggerData[]
			{ new LayeredUnityEventCollider2DTriggerData(new UnityEventCollider2D(), new LayerMask()) };

			UnityEventToolsExpansion.AddPersistentListener(this._onTriggerEnterData[0]._Event, inputActionExecutor.Activate);

			this._onTriggerExitData = new LayeredUnityEventCollider2DTriggerData[]
			{ new LayeredUnityEventCollider2DTriggerData(new UnityEventCollider2D(), new LayerMask()) };
